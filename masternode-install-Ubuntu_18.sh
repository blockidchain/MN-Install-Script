...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='blockidcoin.conf'
CONFIGFOLDER='/root/.blockidcoin'
COIN_DAEMON='blockidcoind'
COIN_CLI='blockidcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/blockidchain/blockidcoin/releases/download/1.0.4/blockidcoin-v1.0.4-daemon-linux.tar.gz'
